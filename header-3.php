...
<header> 
    <nav>
		<div class="container-fluid-md">
			...
			<a href="#" data-bs-toggle="modal" data-bs-target="#dostupModal" class="top-btn"><div class="action-btn d-lg-block">Получить доступ</div></a> 
	...
	<div class="container d-flex align-items-center justify-content-between">
        ...
        <div class="d-flex align-items-center">
			...
			<a href="#" data-bs-toggle="modal" data-bs-target="#dostupModal">
				<div class="action-btn d-none d-lg-block"><?php $header_btn_text = get_field('header_btn_text', 5); echo $header_btn_text; ?></div>
			</a>
		</div>
    </div>
